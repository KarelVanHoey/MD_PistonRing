...
from EngineParts_coated import Engine  #import all classes from file
from TriboContact_coated import TriboContact #import all classes from file
...
while time<Time.nt:
    ...
    if VisualFeedbackLevel>0:
        ...
        if SaveFig2File:# and round(Time.t[time]*1000,5)*100 % 10 == 0:
            ...
            figname="Figures_c/PT@Time_"+"{0:.2f}".format(round(Time.t[time]*1000,5))+"ms.png" 
            fig.savefig(figname, dpi=300)
        plt.close(fig)
